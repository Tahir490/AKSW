        ...
        <section class="sidebar">
            ...
            <?php echo Menu::widget([
                ...
                'items' => [
                    ...
                    [
                        'label' => Yii::t('backend', 'AKSW-Backend'),
                        'url' => '#',
                        'icon' => '<i class="fa fa-edit"></i>',
                        'options' => ['class' => 'treeview'],
                        'active' => in_array(Yii::$app->controller->id, ['page', 'article', 'article-category', 'widget-text', 'widget-menu', 'widget-carousel']),
                        'items' => [
                            ['label' => Yii::t('backend', 'Member Info'), 'url' => ['/member-info/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>', 'active' => (Yii::$app->controller->id == 'page')],
                            ['label' => Yii::t('backend', 'Residence Info'), 'url' => ['/residence-info/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>', 'active' => (Yii::$app->controller->id == 'page')],
                           
                        ]
                    ],
                     [
                        'label' => Yii::t('backend', 'AKSW-Frontend'),
                        'url' => '#',
                        'icon' => '<i class="fa fa-edit"></i>',
                        'options' => ['class' => 'treeview'],
                        'active' => in_array(Yii::$app->controller->id, ['page', 'article', 'article-category', 'widget-text', 'widget-menu', 'widget-carousel']),
                        'items' => [
                            ['label' => Yii::t('backend', 'Member Info'), 'url' => ['/member-info/create'], 'icon' => '<i class="fa fa-angle-double-right"></i>', 'active' => (Yii::$app->controller->id == 'page')],
                            ['label' => Yii::t('backend', 'Residence Info'), 'url' => ['/residence-info/create'], 'icon' => '<i class="fa fa-angle-double-right"></i>', 'active' => (Yii::$app->controller->id == 'page')],
